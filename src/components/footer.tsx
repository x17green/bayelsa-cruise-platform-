    ...
    <footer className="bg-primary text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent to-orange-400 flex items-center justify-center">
        ...
        <motion.div
          ...
          className="py-8 border-t border-white/10 flex justify-center gap-6"
        >
          <a
            href="#"
            className="text-white/70 hover:text-accent transition-colors duration-200"
